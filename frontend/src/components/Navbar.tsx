      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold bg-gradient-to-red from-primary-400 to-gold-400 bg-clip-text bg-white text-transparent cursor-pointer" onClick={()=>{navigate("/home")}}>
              PlinkoPlay
            </span>
          </div>
